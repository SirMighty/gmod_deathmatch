		...
		if( v != LocalPlayer( ) ) then
			...
			if( v:Alive( ) ) then
				...
				if( v:GetNWString("vTitle") == nil ) then
					...
					draw.SimpleText(v:Nick(), "Trebuchet24", screenpos.x, screenpos.y, Color(color.r, color.g,color.b,alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(0,0,0,alpha))
