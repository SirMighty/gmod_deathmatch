...
function NewHUD()
	...
	--Teamscore
	draw.SimpleText( "" .. team.TotalFrags(1), "DermaLarge", ScrW() / 2 - 15, 2, Color( 0, 0, 255, 220 ), TEXT_ALIGN_RIGHT, TEXT_ALIGN_BOTTOM)
	draw.SimpleText( "/", "DermaLarge", ScrW() / 2, 2, Color( 50, 50, 50, 220 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
	draw.SimpleText( "" .. team.TotalFrags(2) .. "", "DermaLarge", ScrW() / 2 + 15, 2, Color( 255, 150, 0, 220 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM)
end
